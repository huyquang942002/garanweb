                ...
                <div class="cart-row">
                    <div class="cart-item cart-column">
                        ...
                        <div class="cart-item-info">
                            <div>
                                <span class="cart-item-title">Gà rán sốt cay</span></div>
                            <div>
                    ...
                    <div class="cart-quantity cart-column">
                        ...
                        <input type="text" class="cart-quantity-input" size="1px" value="1">
                        <input type="button" class="plus quantity-btn" value="+">
                    </div>
                </div>
                ...
                <div class="price-total-container">
                    <div class="price-total-block">
                        <div class="price-total-items-left">
                            <span id="product-price-total" class="price-total-items-content-left">Tổng đơn hàng</span>
                        </div>
                        <div class="price-total-items-right">
                            <span id="product-price-total-value" class="price-total-items-content-right">0</span>
                        </div>
                    </div>
                    <div class="price-total-block">
                        <div class="price-total-items-left">
                            <span class="price-total-items-content-left">Phí giao hàng</span>
                        </div>
                        <div class="price-total-items-right">
                    ...
                    <div class="price-total-block">
                        <div class="price-total-items-left">
                            <span class="price-total-items-content-left"><b>Tổng thanh toán</b></span>
                        </div>
                        <div class="price-total-items-right">
                            <span class="price-total-items-content-right">0</span>
                        </div>
                      ...
                      Vị trí
                       ...
                       +84 123456789
                        ...
                        <a href="">
                            ...
                            <span>
                      Email: lienhe@abcvietnam.com.vn
                    </span>
                        </a>
                    </div>
                </div>
