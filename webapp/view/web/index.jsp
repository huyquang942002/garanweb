...
<link rel="shortcut icon"
	href="<c:url value='${pageContext.request.contextPath}/view/web/images/favicon.png' />"
	type="">
					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						<ul class="navbar-nav  mx-auto ">
							<li class="nav-item active"><a class="nav-link"
								href="index.jsp">Trang chủ <span class="sr-only">(current)</span></a></li>
							<li class="nav-item"><a class="nav-link"
								href="${pageContext.request.contextPath}/allproduct">Thực
									đơn</a></li>
							<li class="nav-item"><a class="nav-link"
								href="${pageContext.request.contextPath}/view/web/about.jsp">About
									us</a></li>
							<li class="nav-item"><a class="nav-link"
								href="${pageContext.request.contextPath}/view/web/book.jsp">Đặt
									bàn</a></li>
						</ul>
						<div class="user_option">

							<c:if test="${sessionScope.user_session == null}">
								<a href="${pageContext.request.contextPath}/view/web/login.jsp"
							...
							<c:if test="${sessionScope.user_session ne null}">
								...
								<li><a
									href="${pageContext.request.contextPath}/LogoutController">Đăng
										Xuất</a></li>
								...
								href="${pageContext.request.contextPath}/view/web/shopping-cart.jsp">
	...
	<section class="food_section layout_padding-bottom">
		<div class="container">
			...
			<ul class="filters_menu">
				...
				<li data-filter=".burger">Mới</li>
				<li data-filter=".pizza">Hot</li>
				<li data-filter=".pasta">Khuyến mãi</li>
				<li data-filter=".fries">Khác</li>
			</ul>
			...
			<div class="btn-box">
				<a href="${pageContext.request.contextPath}/trang-chu"> Xem thêm </a>
			</div>
		</div>
	</section>
		...
		<div class="container  ">
			...
			<div class="row">
				<div class="col-md-6 ">
					<div class="img-box">
						<img
							src="${pageContext.request.contextPath}/view/web/images/about-img.png"
							alt="">
					</div>
				</div>
				<div class="col-md-6">
			...
			<div class="row">
				...
				<div class="col-md-4 footer-col">
					<div class="footer_detail">
						<a href="${pageContext.request.contextPath}/trang-chu" class="footer-logo"> ABC Chicken </a>
